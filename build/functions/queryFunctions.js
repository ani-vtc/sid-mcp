 ...
 */
export async function anyQuery({ prj = "magnetic-runway-428121", ds = "schools", tbl = "", select = "*", conditions = [] } = {}) {
    try {
...
export async function getTables({ prj = "magnetic-runway-428121", ds = "schools" } = {}) {
    try {
        // Base API configuration
        const baseUrl = "https://backend-v1-1010920399604.northamerica-northeast2.run.app";
        let idToken;
...
export default { getTables, anyQuery, getDatabases };
